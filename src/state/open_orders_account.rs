...
impl anchor_lang::Discriminator for OpenOrdersAccount {
    const DISCRIMINATOR: [u8; 8] = [255, 194, 78, 123, 16, 105, 208, 165];
}

unsafe impl bytemuck::Pod for OpenOrdersAccount {}
unsafe impl bytemuck::Zeroable for OpenOrdersAccount {}

impl anchor_lang::ZeroCopy for OpenOrdersAccount {}
...
unsafe impl bytemuck::Pod for OpenOrder {}
unsafe impl bytemuck::Zeroable for OpenOrder {}
